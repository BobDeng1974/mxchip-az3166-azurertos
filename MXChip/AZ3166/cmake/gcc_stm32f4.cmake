# To Learn: -ffast-math -ftree-vectorize cannot be used
set(CMAKE_C_FLAGS "-mthumb -fno-builtin -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -Wall -std=gnu11 -ffunction-sections -fdata-sections -fomit-frame-pointer -mabi=aapcs -fno-unroll-loops -ffreestanding -fsigned-char -fmessage-length=0 -fshort-enums" CACHE INTERNAL "c compiler flags")
...
set(CMAKE_EXE_LINKER_FLAGS "--specs=nosys.specs -Wl,--gc-sections -mthumb -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -mabi=aapcs" CACHE INTERNAL "executable linker flags")
...
set(STM32_CHIP_TYPES 405xx 415xx 407xx 417xx 427xx 437xx 429xx 439xx 446xx 401xC 401xE 411xE 412Rx CACHE INTERNAL "stm32f4 chip types")
set(STM32_CODES "405.." "415.." "407.." "417.." "427.." "437.." "429.." "439.." "446.." "401.[CB]" "401.[ED]" "411.[CE]" "412..")

macro(STM32_GET_CHIP_TYPE CHIP CHIP_TYPE)
    string(REGEX REPLACE "^[sS][tT][mM]32[fF](4[01234][125679].[BCEGI]).*$" "\\1" STM32_CODE ${CHIP})
    set(INDEX 0)
...
macro(STM32_GET_CHIP_PARAMETERS CHIP FLASH_SIZE RAM_SIZE CCRAM_SIZE)
    string(REGEX REPLACE "^[sS][tT][mM]32[fF](4[01234][125679].[BCEGI]).*$" "\\1" STM32_CODE ${CHIP})
    string(REGEX REPLACE "^[sS][tT][mM]32[fF]4[01234][125679].([BCEGI]).*$" "\\1" STM32_SIZE_CODE ${CHIP})
